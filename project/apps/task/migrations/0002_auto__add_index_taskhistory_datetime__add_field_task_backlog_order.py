...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'TaskHistory', fields ['datetime']
        db.create_index(u'task_taskhistory', ['datetime'])

        # Adding field 'Task.backlog_order'
        db.add_column(u'task_task', 'backlog_order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Removing index on 'TaskHistory', fields ['datetime']
        db.delete_index(u'task_taskhistory', ['datetime'])

        # Deleting field 'Task.backlog_order'
        db.delete_column(u'task_task', 'backlog_order')
